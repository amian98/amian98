...
<!--
**amian98/amian98** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
class SoftwareDeveloper:
    ...
    def __init__(self):
        self.name = "Amian Gomez"
        self.role = "Developer"
        self.language_spoken = ["es_CU", "en_US"]

    def say_hi(self):
        print("It's a pleasure for you to meet me.")
